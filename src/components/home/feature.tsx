...
const BorderLinearProgress = styled(LinearProgress, {
  ...
  [`& .${linearProgressClasses.bar}`]: {
    borderRadius: 5,
    ...(order === 1 && {
      backgroundColor: '#19a4ce',
    }),
    ...(order === 2 && {
      backgroundColor: '#871cb9',
    }),
    ...(order === 3 && {
      backgroundColor: '#08a159cc',
    }),
  },
}))
...
const HomeFeature: FC = () => {
  return (
    <Box id="feature" sx={{ py: { xs: 10, md: 6 }, backgroundColor: 'background.paper' }}>
      <Container>
            ...
            <Box sx={{ position: 'relative' }}>
              ...
              >
                ...
                <Box sx={{ mb: 2 }}>
                  ...
                  <BorderLinearProgress variant="determinate" color="inherit" value={50} order={1} />
                </Box>
                <Box sx={{ mb: 2 }}>
                  <Typography variant="subtitle1" color="text.secondary">
                    Consulting
                  </Typography>
                  <BorderLinearProgress variant="determinate" color="inherit" value={75} order={2} />
                </Box>
                <Box sx={{ mb: 2 }}>
                  <Typography variant="subtitle1" color="text.secondary">
                    Developments
                  </Typography>
                  <BorderLinearProgress variant="determinate" color="inherit" value={90} order={3} />
                </Box>
              </Box>
              ...
              >
                ...
                >
                  ...
                  <Typography sx={{mb: 1, fontWeight: 600, lineHeight: 1 }}>Business Growth</Typography>
                  <Box
                    sx={{
                      height: 85,
                      width: 85,
