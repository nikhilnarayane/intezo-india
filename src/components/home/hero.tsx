...
const ScrollLinkTyped = ScrollLink as unknown as React.ComponentType<any>
        ...
        <Grid container spacing={0} sx={{ flexDirection: { xs: 'column', md: 'unset' } }}>
          <Grid item xs={12} md={7}>
            ...
            >
              <Box sx={{ mb: 3 }}>
                ...
                >
                  ...
                  >
                    ...
                    <Box
                      sx={{
                        ...
                        '& img': { width: { xs: 130, md: 200 }, height: 'auto' },
                      }}
                    >
                  ...
                  >
                    ...
                    <svg version="1.1" viewBox="0 0 3183 3072" style={{ top: '-8px' }}>
                      <g id="Layer_x0020_1">
                        <path
                          fill="#127C71"
              ...
              <Box sx={{ '& button': { mr: 2 } }}>
                ...
                <ScrollLinkTyped to="popular-course" spy={true} smooth={true} offset={0} duration={350}>
                  <StyledButton color="primary" size="large" variant="contained">
                    Get Started
                  </StyledButton>
                </ScrollLinkTyped>
                <ScrollLinkTyped to="video-section" spy={true} smooth={true} offset={0} duration={350}>
          ...
          <Grid item xs={12} md={5} sx={{ position: 'relative' }}>
            ...
            >
              ...
              >
                <Image src="/images/consultant.png" alt="Consultant icon" width={50} height={40} quality={97} />
              </Box>
              <Box>
                <Typography
                  component="h6"
                ...
                <Typography variant="subtitle1" sx={{ color: 'text.secondary', lineHeight: 1.3 }}>
                  for Inspiring Spaces and Digital Innovation
                </Typography>
              </Box>
            </Box>
            <Box sx={{ lineHeight: 0 }}>
